...
function get_todos() {
    ...
    /* If the input is not null then JSON.parse will communitcate with the web browser to make the task a JS object. */
    if (todos_str !== null) {
        todos = JSON.parse(todos_str);
    }
    return todos;
}
/* This function adds the unputed task to the get_todos function array */
function add() {
